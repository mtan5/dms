...
import { ClientNewFamilyInfo } from "./ClientNewFamilyInfo";
...
import { ClientEditChildrenInfo } from "../editform/ClientEditChildrenInfo";
import { ClientEditParentInfo } from "../editform/ClientEditParentInfo";

interface ClientAddFormProps{
    modalCloseHandler: Function;
    submitNewClientForm:Function;
}

export function ClientAddForm({modalCloseHandler, submitNewClientForm}: ClientAddFormProps){
    let renderedErrors;
    const dispatch = useDispatch();
    let {familyName, street, city, postal, income, errors} = useSelector<IRootState, iClientForm>((state) => {
    ...
    const actionBar = (
        <div className="flex items-center justify-between">
            <Button className="m-1" success rounded onClick={submitNewClientForm}>Submit</Button>
